...
local function playDeadAnimation()
    ...
    if QBX.PlayerData and QBX.PlayerData.metadata and QBX.PlayerData.metadata.ishandcuffed ~= nil then
        deadAnim = not QBX.PlayerData.metadata.ishandcuffed and 'dead_a' or 'dead_f'
    end
